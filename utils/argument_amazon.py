...
def arg_parser_preprocessing():
    ...
    parser.add_argument("--sentires_dir", dest="sentires_dir", type=str, default="/common/home/ps1279/PycharmProjects/pythonProject/counter/datasets/reviews.pickle",
                        help="path to pre-extracted sentires data")
    parser.add_argument("--review_dir", dest="review_dir", type=str, default="/common/home/ps1279/PycharmProjects/pythonProject/counter/datasets/Video_Games_5.json",
